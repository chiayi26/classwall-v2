...
const RESTAURANTS: Restaurant[] = [
  ...
  {
    id: "0c8f4d9f-9b55-4b8d-b4d0-8d4e4eb7f2f5",
    name: "嚐見麵",
    building: "敬業樓",
    description: "敬業樓 地標餐廳",
  },
      ...
      <div className="flex flex-col gap-6 rounded-[2rem] border border-border/70 bg-card/80 p-6 shadow-[0_24px_80px_-40px_oklch(0.18_0.1_48_/_0.4)] sm:p-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.3fr_0.9fr]">
          ...
          <section aria-label="評分與評論表單" className="space-y-4">
            ...
            <div className="rounded-[2rem] border border-border/70 bg-muted/50 p-5 text-sm text-muted-foreground">
              <p className="font-medium text-foreground">提示</p>
              <ul className="mt-3 space-y-2 list-disc pl-5">
                <li>請選擇你最真實的評分，1~5 顆星皆可。</li>
                <li>評論會存到 Supabase 的 reviews table。</li>
                <li>若出現錯誤，請確認資料庫 migration 已部署。</li>
              </ul>
            </div>
          </section>
        </div>
